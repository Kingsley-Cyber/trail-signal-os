...
integration-check-score:
	PYTHONPATH=. $(PYTHON) -m unittest tests.test_score_n26.IntegrationCheckScore -v

integration-check-explain:
	PYTHONPATH=. $(PYTHON) -m unittest tests.test_explain_n27.IntegrationCheckExplain -v

integration-check-tiers:
	PYTHONPATH=. $(PYTHON) -m unittest tests.test_tiers_n28.IntegrationCheckTiers -v

integration-check-freshness:
	PYTHONPATH=. $(PYTHON) -m unittest tests.test_freshness_n29.IntegrationCheckFreshness -v

integration-check-decide:
	PYTHONPATH=. $(PYTHON) -m unittest tests.test_decide_n30.IntegrationCheckDecide -v

integration-check-graph-defs:
	PYTHONPATH=. $(PYTHON) -m unittest tests.test_graph_defs_n31 -v
